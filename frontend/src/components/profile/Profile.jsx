  ...
  useEffect(() => {
    const fetchProfileAndArticles = async () => {
      try {
        ...
        if (!userResponse.ok) {
          setError(userData.error || "Impossible de charger le profil");
          setLoading(false);
          return;
        }
        ...
        if (articlesResponse.ok) {
          ...
          console.warn("Impossible de charger les articles:", articlesData.error);
        }
    ...
    if (isLoggedIn) fetchProfileAndArticles();
  }, [token, isLoggedIn]);
